    ...
    def initialise():
        while True :
            try :
                ...
                m = float(input("Veuillez entrer la masse du pendule (en kg) "))
                l = float(input("Veuillez entrer la longueur du pendule (en m) "))
                g = float(input("Veuillez entrer la valeur de l'accélération de la pesanteur "))
                teta =[]
                teta_zero = float(input("Veuillez entrer l'angle initial du pendule (en °)"))
                L = float(input("Veuillez entrer la latitude de l'emplacement où vous vous situez (Paris = 48.75) "))
                L = (L*pi/180) 
