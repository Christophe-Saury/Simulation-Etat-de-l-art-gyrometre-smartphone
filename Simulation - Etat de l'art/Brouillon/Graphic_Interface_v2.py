...
def show_foucault(): 
    canvas.itemconfig(1, state='visible')
    canvas.itemconfig(2, state='visible')
    canvas.itemconfig(3, state='visible')


def show_pendule_simple():
    canvas.itemconfig(4, state='visible')
    canvas.itemconfig(5, state='visible')
    canvas.itemconfig(6, state='visible')
    canvas.itemconfig(7, state='visible')
